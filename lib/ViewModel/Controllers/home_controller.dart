...
class HomeController extends GetxController {
  ...
  String getHour(int index) =>
      Utilities.formatTimeWithoutAmPm(model.value!.days![0].hours![index].datetime.toString());
  String getImage(int index) =>
      Utilities().imageMap[model.value!.days![0].hours![index].conditions.toString()] == null
